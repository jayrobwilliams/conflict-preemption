...
## create raster directory in working directory to hold results of crop
## operations. this is necessary so that the files can be explicitly referenced
## for combining them into a rasterbrick
...
## vectors of observed and unobserved years
