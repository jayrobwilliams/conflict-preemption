...
#SBATCH -o logs/nl-grid-bord-cy-%j.out # Standard output
#SBATCH -e logs/nl-grid-bord-cy-%j.out # Standard error

# load the appropriate R module
module load r/3.5.0

# Use Rscript to run analysis
Rscript --vanilla Analysis\ nl_grid_bord_country_year.R
