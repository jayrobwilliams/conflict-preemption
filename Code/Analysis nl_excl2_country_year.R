...
save(margs_gg_pop, file = here::here('Figure Data/marg_eff_pop_df_excl2_cy.RData'))
...
## write marginal effects plot dataframe to disk
save(margs_gg_bord, file = here::here('Figure Data/marg_eff_bord_df_excl2_cy.RData'))
